...
namespace AngelBroking
{
    ...
    internal class WebSocket 
    {
        ...
        // Declare the continuationAction as a field or a property of your class
        private Action<Task<WebSocketReceiveResult>> continuationAction;
        /// <summary>
        ...
        public void Connect(string Url, Dictionary<string, string> headers = null)
        {
            ...
            try
            {
                ...
                _ws.ConnectAsync(new Uri(_url), source.Token).Wait();
            }
                ...
                callback = t =>
                {
                    ...
                    catch (Exception e)
                    {
                        if (IsConnected())
                        {
                            ...
                            // Console.WriteLine("Buffer: " + BitConverter.ToString(buffer));                        //// added
                        }
                        else
